        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Stacked</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Sidebar</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2">
              <li>
                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11  bg-gray-100 ">Products</a>
              </li>
              <li>
                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11  bg-gray-100 ">Users</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Pricing</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Maintenance</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">404 not found</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">500 server error</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-auth" class="hidden py-2 space-y-2">
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Sign in</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Sign up</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Forgot password</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Reset password</a>
              </li>
              <li>
                <a href="" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Profile lock</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="dropdown-playground" class="space-y-2 py-2">
              <li>
                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11">Stacked</a>
              </li>
              <li>
                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11">Sidebar</a>
              </li>
            </ul>
          </li>
        </ul>
