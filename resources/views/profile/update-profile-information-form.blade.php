<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="mat_code" value="{{ __('Matricula') }}" />
            <x-input id="mat_code" type="text" class="mt-1 block w-full" wire:model="state.mat_code"
                autocomplete="mat_code" />
            <x-input-error for="mat_code" class="mt-2" />
        </div>
        <!-- Name -->
        <div class="col-span-6 sm:col-span-4">
