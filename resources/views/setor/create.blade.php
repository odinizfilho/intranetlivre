        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form action="{{ route('setor.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="cod_setor"
                            class="block text-gray-700 text-sm font-bold mb-2">{{ __('Código do setor') }}</label>
                        <input type="text" name="cod_setor" id="cod_setor"
                            class="border border-gray-400 rounded w-full py-2 px-3" value="{{ old('cod_setor') }}"
                            required>
                    </div>

                    <div class="mb-4">
                        <label for="nome"
                            class="block text-gray-700 text-sm font-bold mb-2">{{ __('Nome do setor') }}</label>
