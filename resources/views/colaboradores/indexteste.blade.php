        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="w-full mb-1">
                        ...
                        <div class="sm:flex">
                            ...
                            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                                <button type="button" data-modal-toggle="add-user-modal" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        @php
                            $setor = $setores->firstWhere('cod_setor', $setor->cod_setor);
                        @endphp
                        @if ($setor)
                            {{ $setor->nome }}
                        @else
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{ route('colaboradores.show', $colaborador->id) }}" class="text-primary-600 hover:text-primary-900">Detalhes</a>
                        <a href="{{ route('colaboradores.edit', $colaborador->id) }}" class="text-primary-600 hover:text-primary-900">Editar</a>
                        <a href="{{ route('colaboradores.delete', $colaborador->id) }}" class="text-primary-600 hover:text-primary-900">Excluir</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="relative bg-white rounded-lg shadow">
    <!-- Modal header -->
    <div class="flex items-start justify-between p-5 border-b rounded-t"><a href="#">
        <h3 class="text-xl font-semibold">
            Add new user
        </h3>
...
<div class="relative bg-white rounded-lg shadow">
    ...
    <div class="p-6 pt-0 text-center">
        ...
        <a href="#" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-user-modal">
            No, cancel
        </a>
    </div>
</div>
